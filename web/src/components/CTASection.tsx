      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-20 md:py-28">
        ...
        >
          ...
          >
            <motion.a
              href="#"
              className="px-8 py-3.5 bg-amber-500 text-[#0d0d0d] font-bold rounded text-sm"
            ...
            <motion.a
              href="#services"
              className="px-8 py-3.5 border border-[#6f4e37]/60 text-[#c4b49a] font-medium rounded text-sm"
