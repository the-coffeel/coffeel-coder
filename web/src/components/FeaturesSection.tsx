        ...
        >
          {features.map((feature, i) => (
            ...
            >
              {/* Icon */}
              <motion.div
                className="mb-5 inline-flex items-center justify-center w-12 h-12 rounded-lg bg-[#6f4e37]/20 text-amber-500"
              ...
              {/* Eyebrow */}
              <p className="font-mono text-[10px] uppercase tracking-widest text-[#6f4e37] mb-2">
                {feature.eyebrow}
              </p>
