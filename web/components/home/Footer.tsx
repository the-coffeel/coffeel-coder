...
const footerLinks = {
  ...
  Places: [
    ...
    { label: "Best for Coding", href: "/places?purpose=coding" },
    { label: "Best for Study", href: "/places?purpose=study" },
  ...
  Projects: [
    ...
    { label: "Submit Project", href: "/projects/submit" },
  ],
            ...
            <div className="flex gap-3 pt-2">
              {[
                ...
                <motion.a
                  ...
                  className="w-8 h-8 flex items-center justify-center border border-[#6f4e37]/40 text-[#6f4e37]"
                  whileHover={{
                    color: "#fbbf24",
                    borderColor: "#d97706",
                    scale: 1.1,
